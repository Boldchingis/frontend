...
import { AddDish } from "../../category/addDish";
import { CardComp } from "../../category/foodCard";
import { useParams } from "next/navigation";
import { Categories } from "../../category/dishCategory";
...
export default function Menu() {
  ...
  const fetchFoodCategory = async () => {
    const res = await fetch(
      `http://localhost:5006/food-category/${params.category}`
    );
    const data = await res.json();
