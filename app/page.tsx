...
export default function App() {
  return <div> 
    ...
    <div className='text-[30px] font-[600] text-black ml-16 h-[500px]'> Categories</div>
...
<div className=' mt-52 w-[1450px] h-[228px] flex justify-around  mx-auto px-8'>
  ...
  <div className='flex flex-col gap-4'>
    ...
    <span>Delivery zone</span>  </div>
  </div>
  {/* Menu Section */}
  <div className=' gap-4 flex flex-col '>
  <span className='text-[16px] text-[#71717A]  font-[400] w-[full]  '>MENU</span>
  ...
  <div className='flex flex-col'>
    <span className='text-[16px] text-[#71717A] font-[400]'>FOLLOW US</span>
    <div className='flex gap-4 justify-center mt-4'>  
       <Instagram className='text-white'/>
  <Facebook className='text-white'/> </div>
